...
ETF_UNIVERSE = {
    ...
    "Commodities": {
        ...
        "SIVR": {"name": "Aberdeen Silver ETF",     "benchmark": "SI=F"},
        "PSLV": {"name": "Sprott Physical Silver",  "benchmark": "SI=F"},
        "USO":  {"name": "US Oil Fund",             "benchmark": "CL=F"},
        "BNO":  {"name": "Brent Crude Oil",         "benchmark": "BZ=F"},
        "DBO":  {"name": "DB Oil Fund",             "benchmark": "CL=F"},
